...
#ifndef HPP_BENCHMARK_DEPRECATED_HH
# define HPP_BENCHMARK_DEPRECATED_HH
...
//  void foo () HPP_BENCHMARK_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar HPP_BENCHMARK_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a HPP_BENCHMARK_DEPRECATED = 0;
//
...
#  define HPP_BENCHMARK_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define HPP_BENCHMARK_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define HPP_BENCHMARK_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HPP_BENCHMARK_DEPRECATED_HH
